    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState){
        ...
        if(!(permissionName.equals("Dangerous:")||permissionName.equals("Normal:")||permissionName.equals("Harmless:"))){
            ...
            if(array.length==3){
                ...
                permissionNameTextView.setText(array[2].replace("_"," "));}else{
        ...
        switch (appRating){
            case(0):  button.setBackgroundColor(Color.argb(200,2,174,0)); break; //Green
            case(1): button.setBackgroundColor(Color.argb(200,255,165,0)); break; //Orange
            case(2):button.setBackgroundColor(Color.argb(200,174,2,0)); break; //Red
        }
