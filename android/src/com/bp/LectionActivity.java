...
public class LectionActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lection = new LectionObject(getIntent().getStringExtra("name"),lectionDescription,getIntent().getStringExtra("type"),getIntent().getIntExtra("delay",0),getIntent().getIntExtra("freetime",0),getIntent().getIntExtra("status",1),getIntent().getIntExtra("acorn",3));
